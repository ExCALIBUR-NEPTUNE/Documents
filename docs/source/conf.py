...
def clean_title(title):
    ...
    for i in ["a", "the", "of", "and", "for", "report", "study", "review", "describes", "milestone",
              "with", "in", "excalibur", "neptune", "on", "programme", "to", "overview",
              "findings", "devices", "models", "associated", "issues", "relevant", "which",
              "techniques", "software", "assessment", "literature"]:
...
list_of_directories_to_ignore = ["2057701",] # the content in these directory shouldn't be displayed
rst_names = []
...
for pdfpath in glob.glob("../../pdfs/**/*.pdf"):
    ...
    f.write("   :keywords: {0}\n\n".format(keywords))
    embed_string = ":pdfembed:`src:_static/{0}, height:1600, width:1100, align:middle`\n\n"
